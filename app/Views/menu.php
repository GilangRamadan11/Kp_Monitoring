...
<style>
    ...
    /* ====== TAMBAHAN: RESPONSIF UNTUK HOVER DI MOBILE ====== */
    /* Efek visual saat tap di layar sentuh */
    @media (hover: none) {
        .menu-card:active {
...
<main class="container my-5">
    ...
    <div class="row justify-content-center g-4">
        ...
        <div class="col-12 col-md-5 col-lg-4">
            <a href="<?= base_url('/input-data-sandaran-kiri') ?>" class="text-decoration-none">
                <div class="card menu-card shadow-sm h-100 border-0">
                    <div class="card-body d-flex flex-column align-items-center py-4">
                        <div class="menu-icon bg-primary bg-opacity-10 p-3 rounded-circle">
                            <i class="bi bi-file-ruled display-4 " style="color:rgb(156, 58, 1);"></i>
                        </div>
        ...
        <div class="col-12 col-md-5 col-lg-4">
            <a href="<?= base_url('/input-data-sandaran-kanan') ?>" class="text-decoration-none">
                <div class="card menu-card shadow-sm h-100 border-0">
                    <div class="card-body d-flex flex-column align-items-center py-4">
                        <div class="menu-icon bg-primary bg-opacity-10 p-3 rounded-circle">
                            <i class="bi bi-file-ruled display-4 " style="color:rgb(169, 0, 31);"></i>
                        </div>
