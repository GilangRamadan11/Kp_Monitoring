...
<body>
  ...
  <ul class="dropdown-menu" aria-labelledby="rembesanDropdown">
    <li>
      <a 
        class="dropdown-item <?= strpos(current_url(), 'input-data') !== false ? 'active' : '' ?>" 
    ...
    <li>
      <a 
        class="dropdown-item <?= strpos(current_url(), 'grafik-data') !== false ? 'active' : '' ?>" 
    ...
    <li>
      <a 
        class="dropdown-item <?= strpos(current_url(), 'tabel_thomson') !== false ? 'active' : '' ?>" 
        href="<?= base_url('tabel_thomson') ?>"
      >
        Tabel Thomson
      </a>
    </li>
