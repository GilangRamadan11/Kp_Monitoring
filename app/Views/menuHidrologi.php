...
<main class="container my-5">
    ...
    <div class="row justify-content-center g-4">
        ...
        <div class="col-12 col-md-5 col-lg-4">
            <a href="<?= base_url('/input-data-curah-hujan') ?>" class="text-decoration-none">
            ...
            <a href="<?= base_url('/input-data-curah-hujan') ?>" class="text-decoration-none">
                <div class="card menu-card shadow-sm h-100 border-0">
                    <div class="card-body d-flex flex-column align-items-center py-4">
                        ...
                        <h5 class="mt-3 menu-title">Data Perhitungan Debit Air</h5>
                        <p class="text-muted small mt-2 text-center">
                            Input dan analisis data Debit Air secara real-time.
                        </p>
                    </div>
                </div>
            </a>
