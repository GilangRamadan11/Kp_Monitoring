...
<body>
  ...
  <a class="nav-link dropdown-toggle <?= (strpos(current_url(), 'input-data') !== false || strpos(current_url(), 'grafik-data') !== false || strpos(current_url(), 'tabel_thomson') !== false) ? 'active' : '' ?>"
     href="#" id="rembesanDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <ul class="dropdown-menu" aria-labelledby="rembesanDropdown">
    <li>
      <a class="dropdown-item <?= strpos(current_url(), 'input-data') !== false ? 'active' : '' ?>" 
         href="<?= base_url('input-data') ?>">
         Data Geoteknik
      </a>
    </li>
    <li>
      <a class="dropdown-item <?= strpos(current_url(), 'grafik-data') !== false ? 'active' : '' ?>" 
         href="<?= base_url('grafik-data') ?>">
         Data
      </a>
    </li>
    <li>
      <a class="dropdown-item <?= strpos(current_url(), 'data/tabel_thomson') !== false ? 'active' : '' ?>" 
         href="<?= base_url('data/tabel_thomson') ?>">
         Tabel Thomson
      </a>
    </li>
  </ul>
