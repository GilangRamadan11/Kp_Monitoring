...
<head>
    ...
    <title>Data Curah Hujan - PT Indonesia Power</title>
</head>
    ...
    <div class="data-container">
        <div class="table-header">
            <h2 class="table-title">
                <i class="fas fa-table me-2"></i>Data Input Curah Hujan
            </h2>

            <div class="btn-group mb-3" role="group">
                <a href="<?= base_url('input-data') ?>" class="btn btn-outline-primary">
                    <i class="fas fa-table"></i> Tabel Curah Hujan
                </a>
                ...
                C:\Users\HP\Downloads\Api-Web-main\Api-Web-main\app\Views\Data\Curah_Hujan\add_data.php
