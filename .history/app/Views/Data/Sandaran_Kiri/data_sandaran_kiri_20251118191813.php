        ...
        <div class="table-header">
            ...
            <div class="btn-group mb-3" role="group">
                <a href="<?= base_url('input-data') ?>" class="btn btn-outline-primary">
                    <i class="fas fa-table"></i> Tabel Sandaran Kiri
                </a>
                ...
                <a href="<?= base_url('data/Add_SandaranKiri') ?>" class="btn btn-outline-primary">
                    <i class="fas fa-plus me-1"></i> Add Data
                </a>
                <a href="<?= base_url('grafik') ?>" class="btn btn-outline-primary">
                    <i class="fas fa-plus me-1"></i> Grafik
                </a>
                ...
                <?php else : ?>
                    <?php $no = 1; foreach ($records as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('data-sandaran-kiri/edit/'.$row['id']) ?>" 
                                   class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>

                                <a href="<?= base_url('data-sandaran-kiri/delete/'.$row['id']) ?>" 
