    ...
    $routes->get('/menuHidrologi', 'MenuHidrologi::index');
    ...
    $routes->get('/input-data-curah-hujan','DataCurahHujanController::CurahHujan');

    //Data Input Curah Hujan Routes
    $routes->get('data/Add_CurahHujan', 'DataCurahHujanController::AddData');
    ...
    $routes->get('data/Add_SandaranKiri', 'DataSandaranKiriController::AddData');
    $routes->post('data-sandaran-kiri/store', 'DataSandaranKiriController::store');
    $routes->get('data-sandaran-kiri', 'DataSandaranKiriController::index');
    
Data/Sandaran_Kiri/add_sandaran_kiri

    // web routes sandaran kanan
    $routes->get('/input-data-sandaran-kanan','DataSandaranKananController::SandaranKanan');

    // Data Input Sandaran Kanan 
    $routes->get('data/Add_SandaranKanan', 'DataSandaranKananController::AddData');