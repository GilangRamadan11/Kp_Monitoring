    ...
    //--- Hidrologi (non API) ---
    $routes->get('hidrologi/check-connection', 'Hidrologi\CheckConnection::index');
    
    // web routes hidrologi
    $routes->get('/menuHidrologi', 'MenuHidrologi::index');
    $routes->get('/input-data-hidrologi', 'DataInputController::hidrologi');
    $routes->get('/grafik-data-hidrologi', 'MenuHidrologi::grafikDataHidrologi');
    $routes->get('/tabel-data-hidrologi', 'ExcelViewerController::tabelDataHidrologi');


    //Data Input Hidrologi
