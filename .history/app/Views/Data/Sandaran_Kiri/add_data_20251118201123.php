    ...
    <div class="form-section">
        ...
        <div class="form-grid">
            <?php for ($i = 1; $i <= 10; $i++): ?>
                ...
                <div class="sr-group">
                    <div class="sr-group-title">L - <?= $num ?></div>
        ...
        <!-- SPZ (Controller hanya punya spz02_feet & spz02_inch) -->
        <div class="form-grid">
            <div class="sr-group">
                <div class="sr-group-title">SPZ - 02</div>

                <div class="value-code-group">
                    <div class="form-group">
                        <label class="form-label">Feet</label>
                        <input type="number" step="0.01" class="form-control" name="spz02_feet">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Inch</label>
                        <input type="number" step="0.01" class="form-control" name="spz02_inch">
                    </div>
                </div>
            </div>
        </div>
