...
/* Saat halaman aktif (class active dari PHP) */
...
/* Saat dropdown terbuka (klik) */
.nav-item.dropdown.show > .nav-link {
  background-color: #0b5ed7;
  color: #fff;
}
/* Pastikan posisi parent benar agar dropdown bisa sejajar */
.nav-item.dropdown {
  position: relative;
}
...
<body>
  ...
  <ul class="dropdown-menu" aria-labelledby="rembesanDropdown">
    <li>
      <a 
        class="dropdown-item <?= strpos(current_url(), 'MenuGeoteknik') !== false ? 'active' : '' ?>" 
        href="<?= base_url('menu') ?>"
      >
